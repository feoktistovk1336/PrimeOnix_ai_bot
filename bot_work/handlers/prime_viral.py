...
# ===== Virale-like blocks for PrimeOnix Viral Lab =====
TOOL_SETTINGS.update({
    "🔥 Вирусные идеи": {
        "key": "viral_ideas",
        "title": "🔥 Вирусные идеи",
        "intro": (
            "🔥 <b>Вирусные идеи</b>\n\n"
            "Собирает идеи для Reels, каруселей, постов и сторис под конкретную нишу.\n\n"
            "На выходе: 20 тем, хуки, форматы, почему может зайти, как адаптировать под VK/TG/IG.\n\n"
            "Выбери тему или нажми «✍️ Своя тема»."
        ),
        "loading": "🔥 Ищу вирусные углы, боли аудитории, форматы и темы...",
    },
    "📈 Анализ конкурента": {
        "key": "competitor_analysis",
        "title": "📈 Анализ конкурента",
        "intro": (
            "📈 <b>Анализ конкурента</b>\n\n"
            "Вставь ссылку/описание конкурента или нишу.\n\n"
            "На выходе: сильные стороны, слабые места, темы, хуки, что повторить, что сделать лучше."
        ),
        "loading": "📈 Анализирую конкурента: позиционирование, контент, оффер, идеи для усиления...",
    },
    "📊 Аудит аккаунта": {
        "key": "account_audit",
        ...
        "intro": (
            "📊 <b>Аудит аккаунта</b>\n\n"
            "Вставь ссылку на VK/Telegram/Instagram или опиши проект.\n\n"
            "На выходе: оформление, контент, оффер, воронка, ошибки и конкретный план улучшений."
        ),
        "loading": "📊 Делаю аудит аккаунта: упаковка, оффер, контент, воронка, точки роста...",
    },
    "🧠 Оценить идею": {
        "key": "idea_score",
        "title": "🧠 Оценка идеи",
        "intro": (
            "🧠 <b>Оценка идеи</b>\n\n"
            "Напиши идею ролика/поста/карусели.\n\n"
            "Я дам viral score, слабые места и как усилить, чтобы идея лучше цепляла."
        ),
        "loading": "🧠 Оцениваю идею: хук, новизна, боль, удержание, шанс на реакцию...",
    },
    "📅 Viral план": {
        "key": "viral_plan",
        "title": "📅 Viral контент-план",
        "intro": (
            "📅 <b>Viral контент-план</b>\n\n"
            "Собирает план на 14/30 дней: Reels, карусели, посты, сторис и лид-магниты.\n\n"
            "Напиши нишу или выбери готовую тему."
        ),
        "loading": "📅 Собираю viral контент-план: темы, форматы, хуки, цели публикаций...",
    },
    "🎯 Хуки": TOOL_SETTINGS["🎯 Hook Generator"],
    "🤖 AI Agent": TOOL_SETTINGS["🤖 AI Agents"],
})
...
def _viral_lab_prompt(kind: str, topic: str, style_block: str = "", profile_block: str = "", memory_block: str = "") -> str:
    base = f"""
{style_block}

Используй профиль автора и память:
{profile_block}
{memory_block}

Ты — PrimeOnix Viral Lab: senior SMM-стратег, performance-маркетолог и редактор вирусного контента.
Тема/ниша/ссылка/идея:
{topic}

Пиши на русском. Без воды. Без markdown-таблиц. Давай готовые решения, которые можно сразу применить.
"""
    tasks = {
        "viral_ideas": """
Сделай генератор вирусных идей уровня Virale.
Выдай:
1. Короткий портрет аудитории и её боли.
2. 20 вирусных идей: формат, хук, почему сработает, куда вести человека дальше.
3. 10 Reels-углов.
4. 6 каруселей.
5. 6 сторис-сценариев.
6. 5 идей лид-магнитов.
7. Что снять/сделать первым сегодня.
""",
        "competitor_analysis": """
Сделай анализ конкурента/ниши.
Выдай:
1. Что у конкурента уже сильное.
2. Где слабые места.
3. Какие темы и форматы вероятно работают.
4. Какие хуки можно адаптировать.
5. Как отстроиться.
6. 10 контент-идей, которые можно сделать лучше.
7. План действий на 7 дней.
Если данных по ссылке мало — честно напиши, что анализ по описанию, и не выдумывай точные цифры.
""",
        "account_audit": """
Сделай аудит аккаунта/сообщества.
Выдай:
1. Первое впечатление за 5 секунд.
2. Позиционирование.
3. Оффер.
4. Оформление.
5. Контент.
6. Воронка в сообщения/заявки.
7. Что мешает подписке/заявке.
8. Конкретные правки: обложка, закреп, меню, кнопка, автоприветствие.
9. План улучшений на 3 дня.
""",
        "idea_score": """
Оцени идею.
Выдай:
1. Viral score от 1 до 10.
2. Почему идея может сработать.
3. Почему может провалиться.
4. Как усилить хук.
5. Какой первый кадр сделать.
6. 5 вариантов заголовка.
7. 3 варианта Reels-сценария.
8. Лучший финальный вариант.
""",
        "viral_plan": """
Собери viral контент-план на 30 дней.
Для каждого дня дай: формат, тема, хук, смысл, визуал, CTA/следующий шаг.
Раздели по неделям: охват, доверие, прогрев, продажи.
Добавь отдельный блок: что публиковать в VK, Telegram и Instagram.
""",
    }
    return base + "\n" + tasks.get(kind, tasks["viral_ideas"])


def build_prime_viral_ideas_prompt(topic, style_block="", profile_block="", memory_block=""):
    return _viral_lab_prompt("viral_ideas", topic, style_block, profile_block, memory_block)


def build_prime_competitor_analysis_prompt(topic, style_block="", profile_block="", memory_block=""):
    return _viral_lab_prompt("competitor_analysis", topic, style_block, profile_block, memory_block)


def build_prime_account_audit_prompt(topic, style_block="", profile_block="", memory_block=""):
    return _viral_lab_prompt("account_audit", topic, style_block, profile_block, memory_block)


def build_prime_idea_score_prompt(topic, style_block="", profile_block="", memory_block=""):
    return _viral_lab_prompt("idea_score", topic, style_block, profile_block, memory_block)


def build_prime_viral_plan_prompt(topic, style_block="", profile_block="", memory_block=""):
    return _viral_lab_prompt("viral_plan", topic, style_block, profile_block, memory_block)
...
async def choose_prime_topic(message: Message, state: FSMContext):
    ...
    if text in ["⬅️ Назад в PRIME PANEL", "⬅️ Назад в админку", "❌ Отмена"]:
        await state.clear()
...
async def _start_prime_generation(message: Message, state: FSMContext, topic: str):
    ...
    builders = {
        ...
        "viral_ideas": build_prime_viral_ideas_prompt,
        "competitor_analysis": build_prime_competitor_analysis_prompt,
        "account_audit": build_prime_account_audit_prompt,
        "idea_score": build_prime_idea_score_prompt,
        "viral_plan": build_prime_viral_plan_prompt,
    }

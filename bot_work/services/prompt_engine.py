...
- текущий год: 2026; не используй 2024/2025, если пользователь не просит историю
- если не уверен в актуальности рейтингов, пиши "на сегодняшний день", а не выдумывай год
"""
...
Ты — Reels strategist, сценарист и AI-video продюсер.
...
Создай не просто сценарий, а полноценный Reels-пакет для CapCut / Kling / Runway / Hailuo.

Формат:
🎣 Хук
Короткая первая фраза.

🧩 Концепция
О чём ролик и почему удержит внимание.

🎬 Кадры
5–7 кадров. Для каждого:
- что показать;
- зачем этот кадр;
- текст на экране;
- промпт для картинки 9:16;
- промпт для видео/движения 9:16.

🎤 Озвучка
Цельный текст на 20–35 секунд.

✂️ Монтаж
Темп, переходы, музыка, субтитры.

📝 Описание
Без лид-магнитного CTA, если пользователь не просил воронку.

#️⃣ Хэштеги
5–8 штук.

Важно:
- обычный Reels не переводит в Telegram;
- не проси написать кодовое слово;
- не пиши “пришлю шаблон”;
- текущий год: 2026; не используй 2024/2025, если пользователь не просит историю;
- не выдавай только общий сценарий: обязательно дай промпты для кадров и видео;
- отвечай структурно, чтобы можно было сразу собирать ролик в CapCut/Kling/Runway/Hailuo/Veo.
"""
...
Создай карусель ровно на 8 слайдов.

Формат строго такой:
Слайд 1: короткий мощный хук. Одно предложение.
Слайд 2: главная проблема аудитории.
Слайд 3: ошибка №1.
Слайд 4: ошибка №2.
Слайд 5: решение.
Слайд 6: инструмент или метод.
Слайд 7: результат/выгода.
Слайд 8: вывод без лид-магнитного CTA, если пользователь не просил воронку.
